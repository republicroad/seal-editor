 ...
 */
function getDataGridPaginationItems(pageIndex: number, pageCount: number, limit: number): DataGridPaginationItem[] {
...
function DataGridPagination(props: DataGridPaginationProps): JSX.Element {
  ...
  const paginationItems = getDataGridPaginationItems(pageIndex, pageCount, mergedProps.moreLimit ?? 5);
        ...
        {isLoading ? (
          ...
          <>
            ...
            >
              ...
              <SelectTrigger aria-label={mergedProps.rowsPerPageLabel} className='w-fit min-w-16' size='sm'>
                <SelectValue />
              </SelectTrigger>
                ...
                {paginationItems.map((item) =>
                  item.type === 'page' ? (
                    <Button
                      ...
                      className={cn(PAGE_BUTTON_WIDTH_CLASS, 'px-1.5 text-sm', 'text-muted-foreground', {
